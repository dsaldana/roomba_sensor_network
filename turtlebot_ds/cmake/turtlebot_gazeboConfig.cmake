...
if("FALSE" STREQUAL "TRUE")
  set(turtlebot_gazebo_SOURCE_PREFIX /tmp/buildd/ros-hydro-turtlebot-gazebo-2.1.0-1precise-20130923-0455)
  set(turtlebot_gazebo_DEVEL_PREFIX /tmp/buildd/ros-hydro-turtlebot-gazebo-2.1.0-1precise-20130923-0455/obj-i686-linux-gnu/devel)
...
foreach(depend ${depends})
  ...
  list(APPEND turtlebot_gazebo_LIBRARIES ${${turtlebot_gazebo_dep}_LIBRARIES})
...
if(turtlebot_gazebo_LIBRARIES)
  _remove_duplicate_libraries(turtlebot_gazebo_LIBRARIES turtlebot_gazebo_LIBRARIES)
endif()
